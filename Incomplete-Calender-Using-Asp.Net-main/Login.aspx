<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="calender.Login" %>
    ...
    <form id="form1" runat="server">
        <div style="border: 3px solid black; padding: 50px; width: 30%; margin-left: 35%; margin-top: 60px">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox1" placeholder="Enter Email ID" class="form-control" runat="server"></asp:TextBox>
                &nbsp;
            </div>
            ...
            <asp:Button ID="Button1" class="btn btn-primary" runat="server" Width="100%" Text="Login" OnClick="Button1_Click" />
            <br />
            <br />
